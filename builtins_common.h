 ...
 * are shared between vm_interpreter.c and builtins.c and kept
...
/* primitive function pointers used by vm_interpreter.c as well */
void do_docol(struct forth_ctx *ctx);
void do_exit(struct forth_ctx *ctx);
void do_lit(struct forth_ctx *ctx);

/* functions in vm_interpreter also used by primitives in builtins.c */
